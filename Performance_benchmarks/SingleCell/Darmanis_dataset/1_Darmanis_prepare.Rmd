...
**In order to run this script (1_Darmanis_perpare.Rmd), the corresponding salmon quantification files GSE84465.rds can be downloaded from Zenodo and put in the Data folder of this GitHub repository.** Alternatively, the exact same quantification files can be downloaded from their original source: http://imlspenticton.uzh.ch/robinson_lab/conquer/data-mae/GSE84465.rds .

1. GSE84465.rds

**If one does not want to run this script, its output can also be downloaded from Zenodo: 02_Darmanis_benchmark_datasets_count.Rdata**
...
**The cell-identifiers of the retained (Darmanis_metadata.Rdata) cells should be downloaded from Zenodo and placed in the data folder of our GitHub page.**
...
Darmanis_scaledTPM <- Darmanis_scaledTPM_all[,cellsOfInterest]
```
...
```{r}
save(DarmanisBenchmarkLenient, DarmanisBenchmarkStringent, file="./Data/02_Darmanis_benchmark_datasets_count.Rdata")
#save(ChenBenchmarkLenient, ChenBenchmarkStringent, file="./Data/02_Darmanis_benchmark_datasets_scaledTPM.Rdata")
```
