...
#quantsf <- tximport(files, type = "salmon", tx2gene = tx2gene, ignoreTxVersion = TRUE, countsFromAbundance = "scaledTPM", txOut = TRUE)
```
...
```{r}
colnames(quantsf$counts) <- unname(substring(files, 62,71))
```

```{r}
saveRDS(quantsf$counts, file = "/Users/jg/Desktop/PhD/DTU_project/Github/dtuPaper/Data/Tasic_data/Tasic_counts.Rds")
#saveRDS(quantsf$counts, file = "/Users/jg/Desktop/PhD/DTU_project/Github/dtuPaper/Data/Tasic_data/Tasic_scaledTPM.Rds")
```
