...
**If one does not want to run this script, its output can also be downloaded from Zenodo: 02_Hsapiens_benchmark_datasets_count.Rdata**
...
```{r}
save(HsBenchmarkLenient, HsBenchmarkStringent, file="./Data/02_Hsapiens_benchmark_datasets_count.Rdata")
# save(HsBenchmarkLenient, HsBenchmarkStringent, file='"./Data/02_Hsapiens_benchmark_datasets_scaledTPM.Rdata")
```
