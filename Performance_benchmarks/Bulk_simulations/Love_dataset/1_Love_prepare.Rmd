...
#txi <- tximport(files = quant_files, type = "salmon", txOut = TRUE, countsFromAbundance="scaledTPM") # if scaledTPM instead of raw counts
...
```{r}
save(loveBenchmarkDataLenient, loveBenchmarkDataStringent, file='/Users/jg/Desktop/PhD/DTU_project/Github/dtuPaper/Benchmarks/Bulk_simulations/Love_dataset_ECC/01_Love_benchmark_data_counts.Rdata')

# save(loveBenchmarkDataLenient, loveBenchmarkDataStringent, file='/Users/jg/Desktop/PhD/DTU_project/Github/dtuPaper/Benchmarks/Bulk_simulations/Love_dataset_ECC/01_Love_benchmark_data_scaledTPM.Rdata') # if scaledTPM instead of raw counts
```
