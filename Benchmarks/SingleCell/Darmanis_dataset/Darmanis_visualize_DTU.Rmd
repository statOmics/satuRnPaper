...
```{r}
if(TRUE) {
    load(file='02_Darmanis_DTU_analysis_count.Rdata')
    #load(file="02_Darmanis_DTU_analysis_scaledTPM.Rdata")  
...
visualize_datasets <- function(dataset,metaInfo,nFilters,nSampleSizes,nRep,nmethods,selection,selection2) {
    ...
    for (j in 1:nPlots) {
        ...
        # png(paste("/Users/jg/Desktop/PhD/DTU_project/Github/dtuPaper/Results/Darmanis_benchmark/plot_icobra_count", selection2[j], "_", sub("^[^f]*", "", selection[j]), ".png", sep = ""),
        #     width     = 5.5,
        #     height    = 4.5,
        #     units     = "in",
        #     res       = 200,
