...
if(TRUE) {
    ...
    #load(file='01_Darmanis_benchmark_data.Rdata')
    load(file="01_Darmanis_benchmark_data_scaledTPM.Rdata")
  
    ### Concatenate
    metaInfo <- c(
        DarmanisBenchmarkLenient,DarmanisBenchmarkStringent
    )
...
```{r}
if(TRUE) {
    #load(file='02_Darmanis_DTU_analysis_full.Rdata')
    load(file="02_Darmanis_DTU_analysis_full_scaledTPM.Rdata")  
    ...
    rm(DarmanisDtuBenchmark_quasiBinomial,
        DarmanisDtuBenchmark_limmaDiffsplice,
        DarmanisDtuBenchmark_DEXSeq,
        DarmanisDtuBenchmark_DRIMSeq,
        DarmanisDtuBenchmark_edgeRdiffsplice,
...
visualize_datasets <- function(dataset,metaInfo,nFilters,nSampleSizes,nRep,nmethods,selection,selection2) {
    ...
    for (j in 1:nPlots) {
        ...
        if (nmethods == 6){
            ...
            titles <- c("50 versus 50 - edgeR filter","100 versus 100 - edgeR filter","50 versus 50 - DRIMSeq filter","100 versus 100 - DRIMSeq filter")
            current_title <- titles[j]
        }
        ...
        png(paste("/Users/jg/Desktop/PhD/DTU_project/Github/dtuPaper/Results/Darmanis_benchmark/plot_icobra_scaledTPM_", selection2[j], "_", sub("^[^f]*", "", selection[j]), ".png", sep = ""),
            width     = 5.5,
            height    = 4.5,
            units     = "in",
            res       = 200,
