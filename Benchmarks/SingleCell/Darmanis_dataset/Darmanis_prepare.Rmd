...
```{r}
#save(DarmanisBenchmarkLenient, DarmanisBenchmarkStringent, file='01_Darmanis_benchmark_data.Rdata')
save(DarmanisBenchmarkLenient, DarmanisBenchmarkStringent, file='c')
```
