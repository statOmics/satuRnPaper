...
```{r}
library(devtools)
devtools::install_local("/Users/jg/Desktop/PhD/DTU_project/qbDTU", force = TRUE, quiet = FALSE)
library(qbDTU)
```
...
Run the analysis for all 8 methods on all (6) Tasic benchmark datasets

```{r}
if(TRUE) {
    ### Load benchmark data
    #load(file='01_Tasic_benchmark_data.Rdata') # TasicBenchmarkLenient, TasicBenchmarkStringent
    load(file='01_Tasic_benchmark_data_scaledTPM_20200907.Rdata')
    #load(file='01_Tasic_benchmark_data_count_20200907.Rdata')

    ### Combine
    names(TasicBenchmarkLenient)   <- paste0(names(TasicBenchmarkLenient)  , '_filterLenient')
    names(TasicBenchmarkStringent) <- paste0(names(TasicBenchmarkStringent), '_filterStringent')

    TasicBenchmarkData <- c(
        TasicBenchmarkLenient,
        TasicBenchmarkStringent
    )
    length(TasicBenchmarkData)
    ...
    # quasiBinomial
    tStart <- Sys.time()
    suppressWarnings(TasicDtuBenchmark_quasiBinomial <- plyr::llply(
    ...
    names(TasicDtuBenchmark_quasiBinomial) <- paste0('quasiBinomial_'    , names(TasicDtuBenchmark_quasiBinomial))
    ...
    #     file='02_Tasic_DTU_analysis_full_count_20200907.Rdata'
    # )
    ...
    save(
        ...
        TasicDtuBenchmark_edgeRdiffsplice,
        TasicDtuBenchmark_DoubleExpSeq,
        file='02_Tasic_DTU_analysis_full_scaledTPM_20200907.Rdata'
    )
}
```
