...
```{r}
if(TRUE) {
    load(file="02_Gtex_DTU_analysis_2017_count.Rdata")
...
visualize_datasets <- function(dataset,metaInfo,nFilters,nSampleSizes,methods,colors,titles,selection) {
    ...
    for (j in 1:nPlots) {
        ...
        # save plot
        png(paste("/Users/jg/Desktop/PhD/DTU_project/Github/dtuPaper/Results/Gtex_benchmark/plot_icobra_2017_count_final_", selection[j], "_", ".png", sep = ""),
        width     = 5.5,
        height    = 4.5,
        units     = "in",
        res       = 200,
...
titles <- c("5 versus 5 - edgeR filter","20 versus 20 - edgeR filter","5 versus 5 - DRIMSeq filter","20 versus 20 - DRIMSeq filter")
...
titles <- c("50 versus 50 - edgeR filter","50 versus 50 - DRIMSeq filter")
