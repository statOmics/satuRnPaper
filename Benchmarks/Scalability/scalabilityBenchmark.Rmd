...
load("Data/Scalability/Scalability/finalOutput_quasiBinomial_1.RData")
load("Data/Scalability/finalOutput_quasiBinomial_2.RData")

# read limmaDiffsplice results
load("Data/Scalability/finalOutput_limmaDiffsplice_1.RData")
load("Data/Scalability/finalOutput_limmaDiffsplice_2.RData")

# read edgeRDiffsplice results
load("Data/Scalability/finalOutput_edgeRDiffsplice_1.RData")
load("Data/Scalability/finalOutput_edgeRDiffsplice_2.RData")

# read DRIMSeq results
load("Data/Scalability/finalOutput_DRIMSeq_1.RData")
load("Data/Scalability/finalOutput_DRIMSeq_2.RData")

# read DoubleExpSeq results
load("Data/Scalability/finalOutput_DoubleExpSeq_1.RData")
load("Data/Scalability/finalOutput_DoubleExpSeq_2.RData")

# read DEXSeq results
load("Data/Scalability/finalOutput_DEXSeq_2.RData")
load("Data/Scalability/finalOutput_DEXSeq_3.RData")
load("Data/Scalability/finalOutput_DEXSeq_4.RData")

# read BANDITS results
load("Data/Scalability/finalOutput_BANDITS_5.RData")
load("Data/Scalability/finalOutput_BANDITS_6.RData")
```
