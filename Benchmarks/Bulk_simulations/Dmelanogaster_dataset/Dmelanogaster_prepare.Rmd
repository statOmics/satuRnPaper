...
```{r}
save(DmBenchmarkLenient, DmBenchmarkStringent, file='01_Dmelanogaster_benchmark_data_ECC_count.Rdata')
save(DmBenchmarkLenient, DmBenchmarkStringent, file='01_Dmelanogaster_benchmark_data_ECC_tpm.Rdata')
```
