...
Load all 9 DTU methods (dataset too large for BANDITS, so BANDITS is omitted here)
...
if(TRUE) {
    ...
    NBSplice_DTU <- function(countData, tx2gene, sampleData) {
        ...
        myDSResults <- suppressWarnings(NBTest(myIsoDataSet, colName, test="F")) ## other option is chisqs
...
Run the analysis for all 9 methods on all datasets (18)

```{r}
# Run DTU analysis on Love et al Benchmark data

if(TRUE) {
    ### Load benchmark data

    load(file='01_love_et_al_benchmark_data_ECC_counts.Rdata')
    #load(file='01_love_et_al_benchmark_data_ECC_tpm.Rdata') # loveBenchmarkDataLenient, loveBenchmarkDataStringent
    ...
    localData <- loveBenchmarkData$samples_used_10_rep_1_filterLenient
    ...
    # quasiBinomial
    tStart <- Sys.time()
    suppressWarnings(loveDtuBenchmark_quasiBinomial <- plyr::llply(
    ...
    # edgeR_diffsplice_DTU : Runtime - fast - done
    ...
    names(loveDtuBenchmark_quasiBinomial) <- paste0('quasiBinomial_'    , names(loveDtuBenchmark_quasiBinomial))
    ...
    save(
        ...
        file='02_love_et_al_benchmark_DTU_analysis_ECC_count.Rdata'
    )
    ...
    #     loveDtuBenchmark_DRIMSeq,
    #     loveDtuBenchmark_NBSplice,
    #     file='02_love_et_al_benchmark_DTU_analysis_ECC_tpm.Rdata'
    # )
