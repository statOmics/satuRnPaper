...
visualize_datasets <- function(dataset,nFilters,nSampleSizes,nrep,nmethods) {
  ...
  for (j in 1:nPlots) {
    ...
    for (k in seq_len(nrep)) {
        ...
        # omit satuRn for supplemeentary figure
    ...
    truth_full$truth <- as.numeric(truth_full$truth)
    ...
    png(paste("/Users/jg/Desktop/PhD/DTU_project/Github/dtuPaper/Results/Love_ECC_benchmark/plot_icobra_subset_scaledTPM_figS1_", j, ".png", sep = ""),
          width     = 5.5,
          height    = 4.5,
          units     = "in",
          res       = 200,
